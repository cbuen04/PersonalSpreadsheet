...
namespace FormulaTests
{
    ...
    public class FormulaTests
    {
        ...
        public void TestSingleNumber()
        {
            ...
            Assert.AreEqual(s1, f1.ToString());
        }
        ...
        {
            Formula f1 = new Formula("x5", s => s.ToUpper(), s => true);
        ...
        public void TestArithmeticWithVariable()
        {
            ...
            Assert.AreEqual("6", f1.Evaluate(s => 4).ToString());
        }
        ...
        public void TestDivideByZero()
        {
            ...
            Assert.AreEqual(new FormulaError("cannot divide by zero"), f1.Evaluate(s => 0));
        }
        ...
        [TestMethod(), Timeout(5000)]
        [TestCategory("22")]
        public void TestQuirkyVariable()
        {
            Formula f1 = new Formula("xx");
            Assert.AreEqual("xx", f1.ToString());
        }
        ...
        public void TestPlusVariable()
        {
            ...
            Assert.AreEqual("10", f1.Evaluate( s => 5).ToString());
        }
        ...
        [TestMethod(), Timeout(5000)]
        [TestCategory("30")]
        public void TestTwoAreEqual()
        {
            Formula f1 = new Formula("1e3 + x2");
            Formula f2 = new Formula("1000 + x2");
        ...
        {
            Formula f1 = new Formula("1e3 + x2", s => s, s => false);
        }
        ...
        {
            Formula f1 = new Formula("x4 + x2 + x5 + x5");
            List<String> f1Vars = new List<string>(f1.GetVariables());
            

            Assert.AreEqual(f1Vars.Count, 3);
        }
